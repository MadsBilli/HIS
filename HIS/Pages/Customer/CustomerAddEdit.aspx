<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CustomerAddEdit.aspx.cs" Inherits="HIS.Pages.Customer.CustomerAddEdit"
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <table style="width: 100%">
            <tr>
                <td>
                    <asp:CheckBox ID="chkShowHideGridColumn" runat="server" Text="Show YTD Sales / Owing"
                        onclick="chkShowHideGridColumn(this,4);" Checked="true" />
                </td>
                <td>
                    <asp:CheckBox ID="chkShowInactiveColumn" runat="server" Text="Inactive Customer"
                        onclick="chkShowHideGridColumn(this,3);" Checked="true" />
                </td>
            </tr>
        </table>
    </div>
                ...
                <td>
                    <asp:GridView runat="server" ID="gvCustomerList" Width="100%" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="YTD_Sales" HeaderText="YTD Sales" HeaderStyle-CssClass="hide"
                                ItemStyle-CssClass="hide" />
                            <asp:BoundField DataField="YTD_Owing" HeaderText="YTD_Owing" HeaderStyle-CssClass="hide"
                                ItemStyle-CssClass="hide" />
                    ...
                    <div id="main">
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox runat="server" ID="txtCustomerName" Width="350px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList runat="server" ID="ddlSalesmanCode" Width="75px" onchange="fillSalesManValue(this);">
                                    </asp:DropDownList>
                                    <asp:TextBox runat="server" ID="txtSalesman" Width="270px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlCompanyType" runat="server" Width="352px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtCity" Width="158px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtTerms" onkeypress="return NumberOnly()" Width="192px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtMainContact" Width="350px"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                                <td colspan="4">
                                    <asp:DropDownList ID="ddlRevenueAccCode" runat="server" Width="455px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:DropDownList ID="ddlDefaultTradeDebtor" runat="server" Width="455px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlPOSPricePrp" runat="server" Width="350px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkExclusive" runat="server" Text="Exclusive" />
                                </td>
                                <td>
                    ...
                    <td style="vertical-align: bottom; background-image: url('../../Images/table_centre_mid.gif')">
                        <div id="Contact">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Button ID="imgContactAddNew" runat="server" Text="Add New" Enabled="false" OnClick="imgContactAddNew_Click"
                                            CssClass="button_blue" />&nbsp;
                                        <asp:Button ID="imgContactSave" runat="server" Text="Save" Enabled="false" OnClick="imgContactSave_Click"
                                            CssClass="button_blue" />
                                    </td>
                                    <td>
                    ...
                    <div id="DeliveryAddress">
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtDAddress1" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="4">
                                    <asp:TextBox runat="server" ID="txtDAddress2" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtDAPostalCode" Width="250px"></asp:TextBox>
                                </td>
                                <td style="width: 10px">
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtDACity" Width="100px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <td style="width: 98%; vertical-align: bottom; background-image: url(../../Images/table_centre_mid.gif)">
                    <div id="costMemo">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkPromptMemo" runat="server" Text="Prompt Memo" />
                                </td>
                            </tr>
                            <tr>
                                <td>
