...
namespace HIS.Pages.Customer
{
    ...
    //delete & update
    //validation
    //data population & edit
    //drop down value population
    //grid pagination
    //contact details
    ...
    public partial class CustomerAddEdit : System.Web.UI.Page
    {
        ...
        {
            CommonFunctions.BindEnumToddl<Common.Gender>(ddlGender, false);
            CommonFunctions.BindEnumToddl<Common.NameSequence>(ddlNameSeq, false);
            CommonFunctions.BindEnumToddl<Common.ContactType>(ddlContactType, true);
            CommonFunctions.BindEnumToddl<Common.Level>(ddlLevel, true);
            CommonFunctions.BindEnumToddl<Common.PreferedDialog>(ddlPreferDialog, false);
            ...
            {
                //Salesman IC
                ddlSalesmanCode.DataSource = res.Tables[0].AsDataView();
                ddlSalesmanCode.DataValueField = "emp_id";
                ddlSalesmanCode.DataTextField = "emp_salesman_id";
                ddlSalesmanCode.DataBind();
                CommonFunctions.InsertEmptyValueToddl(ddlSalesmanCode);
                //Customer Type
            }
            if (res.Tables.Count > 1 && res.Tables[1] != null && res.Tables[1].Rows.Count > 0)
            {
                //Company Type
                //ddlCompanyType.DataSource = res.Tables[1].AsDataView();
                //ddlCompanyType.DataValueField = "emp_status_id";
                //ddlCompanyType.DataTextField = "emp_status_desc";
                //ddlCompanyType.DataBind();
                CommonFunctions.InsertEmptyValueToddl(ddlCompanyType);                
            }
            ...
            {
                //Revenue ACC Code
                ddlRevenueAccCode.DataSource = res.Tables[3].AsDataView();
                ddlRevenueAccCode.DataValueField = "acc_code";
                ddlRevenueAccCode.DataTextField = "acc";
                ddlRevenueAccCode.DataBind();
                CommonFunctions.InsertEmptyValueToddl(ddlRevenueAccCode);
            }
            ...
            {
                //POS price Prp
                ddlPOSPricePrp.DataSource = res.Tables[5].AsDataView();
                ddlPOSPricePrp.DataValueField = "txtPriceGrp";
                ddlPOSPricePrp.DataTextField = "txtDescription";
                ddlPOSPricePrp.DataBind();
                CommonFunctions.InsertEmptyValueToddl(ddlPOSPricePrp);
            }
        ...
        {
            var res = new CustomerAddEditAssembler().GetCustomerList();
        ...
        protected void imgbtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                custVendor.cust_br_add1 = txtDAddress1.Text.Trim();
                custVendor.cust_br_add2 = txtDAddress2.Text.Trim();
                custVendor.cust_br_add3 = txtDAPostalCode.Text.Trim();
                ...
                custVendor.cust_type = "C";

                custVendor.cust_blacklisted = ChkBlacklisted.Checked;
                custVendor.cust_exclusive = chkExclusive.Checked;
                custVendor.cust_rmk = txtCustomerRemark.Text.Trim();
                custVendor.cust_prompt_rmk = chkPromptMemo.Checked.ToString();
                custVendor.cust_inactive = chkInactiveCustomer.Checked;

                custVendor.cust_company_type = ddlCompanyType.SelectedValue;
                ...
                custVendor.cust_pos_price_grp = ddlPOSPricePrp.SelectedValue;
                custVendor.cust_revenue_acc_code = ddlRevenueAccCode.SelectedValue;
                custVendor.cust_salesman_code = ddlSalesmanCode.SelectedValue;
        ...
        private void FillDetails(CustVendorUIMapper cust)
        {
            ...
            txtDAddress1.Text = cust.cust_br_add1;
            txtDAddress2.Text = cust.cust_br_add2;
            txtDAPostalCode.Text = cust.cust_br_add3;
            txtDACity.Text = cust.cust_br_add4;
            ...
            if (ddlSalesmanCode.Items.FindByValue(cust.cust_salesman_code) != null)
                ddlSalesmanCode.SelectedValue = cust.cust_salesman_code;
            // txtSalesman.Text = ddlSalesmanCode.SelectedText;

            if (ddlCompanyType.Items.FindByValue(cust.cust_company_type) != null)
                ddlCompanyType.SelectedValue = cust.cust_company_type;
            ...
            if (ddlPOSPricePrp.Items.FindByValue(cust.cust_pos_price_grp) != null)
                ddlPOSPricePrp.SelectedValue = cust.cust_pos_price_grp;

            if (ddlRevenueAccCode.Items.FindByValue(cust.cust_revenue_acc_code) != null)
                ddlRevenueAccCode.SelectedValue = cust.cust_revenue_acc_code;
            chkExclusive.Checked = cust.cust_exclusive;
            ...
            chkPromptMemo.Checked = Convert.ToBoolean(cust.cust_prompt_rmk);
