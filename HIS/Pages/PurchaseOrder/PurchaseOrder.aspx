<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PurchaseOrder.aspx.cs" Inherits="HIS.Pages.Quotation.PurchaseOrder" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <div id="Contact">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="purord_cust_id" runat="server" Width="20px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="purord_cust_name" runat="server" Style="width: 305px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_resp" runat="server" Style="width: 305px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_address" runat="server" Width="325px"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_siteadd" runat="server" Style="width: 305px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_add2" runat="server" Width="180px"></asp:TextBox>
                                                    City :
                                                    <asp:TextBox ID="txt_purord_city" runat="server" Style="width: 100px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_siteadd2" runat="server" Style="width: 180px;"></asp:TextBox>City:
                                                    <asp:TextBox ID="txt_purord_sitecity" runat="server" Style="width: 89px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_postal" runat="server" Style="width: 160px;"></asp:TextBox>
                                                    &nbsp;Country:
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_sitepos" runat="server" Style="width: 139px;"></asp:TextBox>
                                                    &nbsp;Country:
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_contact" runat="server" Style="width: 325px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_sitecon" runat="server" Style="width: 305px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_tel" runat="server" Style="width: 140px;"></asp:TextBox>
                                                    &nbsp; HP &nbsp;
                                                    <asp:TextBox ID="txt_purord_Hp" runat="server" Style="width: 142px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_sitetel" runat="server" Style="width: 130px;"></asp:TextBox>
                                                    &nbsp; HP &nbsp;
                                                    <asp:TextBox ID="txt_purord_sitehp" runat="server" Style="width: 130px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_fax" runat="server" Style="width: 160px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_sitefax" runat="server" Style="width: 160px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_email" runat="server" Style="width: 325px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_purord_siteemail" runat="server" Style="width: 305px;"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td colspan="2">
                                                    <asp:TextBox ID="txt_purord_cust" runat="server" Style="width: 325px;"></asp:TextBox>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding-left: 2px;">
                                            <dtc1:DateSelectControl ID="purord_createddate" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_purord_created" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="purord_salesby">
                                                <asp:ListItem Text="- Select -" Value=""></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_purord_qutrefno" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_purord_invrefno" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td style="padding-left: 2px;">
                                            <dtc1:DateSelectControl ID="dsc_purord_install" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_purord_time" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt_purord_by" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 45%;">
                                        ...
                                        <td style="padding-left: 2px;">
                                            <asp:DropDownList ID="ddl_purord_round" runat="server" Style="width: 70px;">
    ...
    <div>
        <table>
            <tr>
                <td>
                    <asp:GridView runat="server" ID="gvpurordItem" Width="750px" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_id" runat="server" Text='1' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Header">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_Header" runat="server" Text='<%# Eval("Header") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Model">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_model" runat="server" Text='<%# Eval("Model") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Type">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_type" runat="server" Text='<%# Eval("Type") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Description">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_desc" runat="server" Text='<%# Eval("Description") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Width">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_width" runat="server" Text='<%# Eval("Width") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Height">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_height" runat="server" Text='<%# Eval("Height") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Ctrl">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_ctrl" runat="server" Text='<%# Eval("Ctrl") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Set">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_setno" runat="server" Text='<%# Eval("Set") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="UOM">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_uom" runat="server" Text='<%# Eval("UOM") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Coloum">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_col" runat="server" Text='<%# Eval("Coloumn") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Qty">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_qty" runat="server" Text='<%# Eval("Qty") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Unit Price">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_amt" runat="server" Text='<%# Eval("UnitPrice") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total Amount">
                                <ItemTemplate>
                                    <asp:TextBox ID="purord_item_tamt" runat="server" Text='<%# Eval("TotalAmount") %>' CssClass="editableGridRow">
                                    </asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
