<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InvoiceItemsSelectionSetup.aspx.cs" Inherits="HIS.Pages.Setup.InvoiceItemsSelectionSetup" EnableEventValidation="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="Script/InvoiceSetupScript.js"></script>
    <div>
                    ...
                    <table>
                        <tr>
                            <td class="legend">
                                ...
                                Invoice Items Selection Setup Module 
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <asp:GridView runat="server" ID="gvList" Width="100%" AutoGenerateColumns="false" AllowPaging="false" CssClass="InsertUpdateDeleteGrid">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S/N">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtId" runat="server" Text='<%# ProcessData(Eval("inv_sel_ln")) %>' BorderStyle="None" BackColor="Transparent" Width="30px" style="text-align:center"  onkeypress='return check_digit(event,this,8,1);'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Description">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDescription" runat="server" Text='<%# Eval("inv_sel_desc") %>' BorderStyle="None" BackColor="Transparent" Width="375px" ></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>      
