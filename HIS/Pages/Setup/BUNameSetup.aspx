<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BUNameSetup.aspx.cs" Inherits="HIS.Pages.Setup.BUNameSetup" EnableEventValidation="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script src="Script/BUNameSetupScript.js"></script>
    <div>
                    ...
                    <table>
                        <tr>
                            <td class="legend">
                                ...
                                Business Units Rpt Name Module
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td style="width: 98%; vertical-align: bottom; background-image: url(../../Images/table_centre_mid.gif)">
                    <div>                       
                        ...
                        <asp:GridView runat="server" ID="gvList" Width="100%" AutoGenerateColumns="false" AllowPaging="false" CssClass="InsertUpdateDeleteGrid">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="BU ID">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtId" runat="server" Text='<%# ProcessData(Eval("bu_id")) %>' BorderStyle="None" BackColor="Transparent" Width="30px" style="text-align:center"  onkeypress='return check_digit(event,this,8,1);'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="BU Rpt Name">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDescription" runat="server" Text='<%# Eval("bu_desc") %>' BorderStyle="None" BackColor="Transparent" Width="375px" ></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>                                                                  
